...
parser.add_argument('--adv_save_x', default='../adv_save_o/mlgcn/voc2007/', type=str, metavar='N',
...
def main_cat():
    ...
    # value is {-1,1}
    y_target = np.load('../adv_save_o/mlgcn/voc2007/y_target.npy')
    y = np.load('../adv_save_o/mlgcn/voc2007/y.npy')
