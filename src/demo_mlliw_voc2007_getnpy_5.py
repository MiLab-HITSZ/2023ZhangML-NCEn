...
parser.add_argument('--adv_file_path', default='../data/voc2007/files/VOC2007/classification_cat_adv.csv', type=str,
                    metavar='N',
                    help='all image names and their labels ready to attack')
...
def main_cat():
    ...
    # load torch model
    model = resnet101_attack(num_classes, pretrained=True, kmax=args.k, alpha=args.alpha, num_maps=args.maps,
                             save_model_path='../checkpoint/cat/voc2007/model_best.pth.tar')
