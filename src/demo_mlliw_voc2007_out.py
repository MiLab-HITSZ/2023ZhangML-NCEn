...
from ml_gcn_model.voc import Voc2007Classification as gcnVoc2007Classification
...
def evaluate_adv(state):
    ...
    # adv_dataset = gcnVoc2007Classification(args.data, 'mlgcn_adv', inp_name='../data/voc2007/voc_glove_word2vec.pkl')
