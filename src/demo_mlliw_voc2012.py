...
def main_e():
    ...
    model0 = inceptionv3_attack(num_classes=num_classes,
                                save_model_path='../checkpoint/mlliw/new_gpmr_voc2012/0model_best.pth.tar')
    model1 = inceptionv3_attack(num_classes=num_classes,
                                save_model_path='../checkpoint/mlliw/new_gpmr_voc2012/1model_best.pth.tar')
    model2 = inceptionv3_attack(num_classes=num_classes,
                                save_model_path='../checkpoint/mlliw/new_gpmr_voc2012/2model_best.pth.tar')
