...
parser.add_argument('--model_path', default='../checkpoint/mlliw/voc2007/base/', type=str, metavar='N',
...
def main_e():
    ...
    model0 = inceptionv3_attack(num_classes=num_classes,
                                save_model_path=args.model_path + '0voc2007_checkpoint.pth.tar')
    model1 = inceptionv3_attack(num_classes=num_classes,
                                save_model_path=args.model_path + '1voc2007_checkpoint.pth.tar')
    model2 = inceptionv3_attack(num_classes=num_classes,
                                save_model_path=args.model_path + '2voc2007_checkpoint.pth.tar')
